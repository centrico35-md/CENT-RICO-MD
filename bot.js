...
// Holds the single live socket + status, shared by the CLI runner and the
// web server so /api/pair and /api/status can reach the same connection.
const state = {
  sock: null,
...
module.exports = { startSocket, requestPairingCode, getStatus, commands };
